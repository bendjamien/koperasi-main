    ...
    <div class="bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
        ...
        <form action="{{ route('users.update', $user) }}" method="POST" class="space-y-4">
            ...
            <div id="kode_absen_container">
                <label for="kode_absen" class="block text-sm font-medium text-gray-700">Kode Absen</label>
                <div class="mt-1 flex gap-2">
                    <input type="text" name="kode_absen" id="kode_absen" value="{{ old('kode_absen', $user->kode_absen) }}"
                ...
                <p class="text-[10px] text-gray-500 italic mt-1">* Kode ini akan otomatis menjadi QR Code untuk absensi kasir.</p>
            </div>
