                ...
                <table class="w-full min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Kode Absen</th>
                        ...
                        @forelse ($users as $user)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    @if($user->role == 'kasir')
                                        @if($user->kode_absen)
                                            <span class="font-mono font-bold text-slate-700 bg-slate-100 px-2 py-1 rounded">{{ $user->kode_absen }}</span>
                                        @else
                                            <span class="text-xs text-rose-500 italic font-medium">Belum diatur</span>
                                        @endif
                                    @else
