            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    @if($produk->gambar_url)
                        <img src="{{ asset('storage/' . $produk->gambar_url) }}" alt="{{ $produk->nama_produk }}" class="w-32 h-32 object-cover rounded-lg border mb-2">
                    @else
                        <div class="w-32 h-32 bg-gray-100 rounded-lg flex items-center justify-center text-gray-400 text-xs border mb-2">Tidak ada gambar</div>
                    @endif
