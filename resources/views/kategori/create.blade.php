<x-app-layout>
    <div class="max-w-3xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="mb-8 flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Tambah Kategori</h1>
                <p class="mt-2 text-sm text-gray-600">Buat kategori baru untuk mengelompokkan produk Anda.</p>
            </div>
            ...
            <form action="{{ route('kategori.store') }}" method="POST" class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama') }}" 
                           placeholder="Misalnya: Makanan, Minuman, Elektronik..."
